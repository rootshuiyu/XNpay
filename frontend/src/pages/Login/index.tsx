...
export default function Login() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        flex: 1,
        background: 'linear-gradient(160deg, #6c5ce7 0%, #4834d4 40%, #341f97 100%)',
        display: 'flex',
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 360 }}>
          ...
          <Form onFinish={onFinish} size="large" layout="vertical">
            ...
            >
              <Input
                ...
                placeholder="请输入用户名"
                style={{ borderRadius: 10, height: 48, background: '#f8f9fa', border: '1.5px solid #eef0f2' }}
              />
            </Form.Item>
            <Form.Item
              name="password"
          ...
          <div style={{
            ...
            <Link to="/merchant/login" style={{ color: '#6c5ce7', fontSize: 13 }}>
              商户登录 &rarr;
            </Link>
          </div>
        </div>
